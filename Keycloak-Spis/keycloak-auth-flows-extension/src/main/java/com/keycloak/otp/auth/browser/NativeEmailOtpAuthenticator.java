 ...
 */
@JBossLog
public class NativeEmailOtpAuthenticator extends AbstractUsernameFormAuthenticator {

    private static final Logger log = Logger.getLogger(NativeEmailOtpAuthenticator.class);
    ...
    private void generateAndSendEmailCode(AuthenticationFlowContext context) {
        ...
        try {
            NotificationService.sendOtpViaEmailProviderAndSms(context, code, ttl);
        } catch (Exception e) {
