...
import com.keycloak.otp.auth.browser.OtpAuthenticatorFormFactory;
 ...
 * Author: Yasir Rehman
 * <p>
 * Factory class for the {@link ConditionalEmailAuthenticatorForm}.
 * Extends the base {@link OtpAuthenticatorFormFactory} to support conditional logic.
 * Provides additional configuration options for conditional OTP handling such as:
 * - user attributes
 * - roles
 * - HTTP headers
 * - fallback outcome
 */
public class ConditionalEmailAuthenticatorFormFactory extends OtpAuthenticatorFormFactory {

    /**
     * Provider ID used to register this conditional authenticator
     */
    public static final String PROVIDER_ID = "email-conditional-authenticator";

    /**
     * Singleton instance of the conditional form-based email authenticator
     */
    public static final ConditionalEmailAuthenticatorForm SINGLETON = new ConditionalEmailAuthenticatorForm();

    /**
     * Returns the unique ID used by Keycloak to identify this authenticator.
     */
    @Override
    public String getId() {
        return PROVIDER_ID;
    ...
    /**
     * Returns help text shown in the admin console describing what this authenticator does.
     */
    @Override
    ...
    /**
     * Returns the configuration properties supported by this authenticator.
     * Includes logic for user attributes, roles, HTTP headers, and default behavior.
     */
    @Override
    ...
    /**
     * Indicates that this authenticator supports per-user setup (enabled).
     */
    @Override
    ...
    /**
     * Creates and returns the singleton instance of the authenticator.
     */
    @Override
