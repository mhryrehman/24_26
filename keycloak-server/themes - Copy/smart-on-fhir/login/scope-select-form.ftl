...
<@layout.registrationLayout displayInfo=true; section>
    ...
    <#elseif section == "form">
        <div class="form-container scope-main-wrap">
            <p class="form-description scope-descp">Please select the scopes you want to grant access to:</p>
            <form id="scope-selection" action="${url.loginAction}" method="post">
                <div class="scope-list">
                    <#list scopes as scope>
                        <div class="scope-item">
							<label class="scope-checkbox"><span class="scope-label">${scope}</span>
							  <input type="checkbox" checked="checked" name="selectedScopes" id="${scope}" value="${scope}">
