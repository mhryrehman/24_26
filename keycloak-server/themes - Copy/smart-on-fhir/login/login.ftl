  ...
  <#elseif section="form">
    <#if realm.password>
      ...
      >
        ...
        <!-- Expect backend to provide captchaSiteKey attribute -->
        <div class="g-recaptcha" data-sitekey="6LdCja4rAAAAAFYY-rTHq7Oo9g61UnK3X7szKblJ"></div>
        <!-- /reCAPTCHA -->
        ...
        <!-- Load Google reCAPTCHA JS (required) -->
